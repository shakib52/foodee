                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav main-nav  clear navbar-right ">
                        <li><a class="navactive color_animation" href="#story">ABOUT</a></li>
                         <li><a class="color_animation" href="#pricing">ONLINE ORDER</a></li>
<!--
...
-->
                        ...
                        <li><a class="color_animation" href="signup.html" target="_blank">LOGIN</a></li>
                            ...
                            <ul>
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Pineapple Juice <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Green Juice <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Soft Drinks <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Carlo Rosee Drinks <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                            ...
                            <ul>
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Beef Steak <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Tomato with Chicken <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Sausages from Italy <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        ...
                                        <div>
                                            <h3>Beef Grilled <a href="onlineorder.html" class="badge bg-primary j9v" target="_blank">order now</a></h3>
                                            <p>Far far away, behind the word mountains.</p>
                                        </div>
                                    </div>
                                    <div class="fh5co-food-pricing">
            ...
            <div class="inner contact">
                ...
                <div class="contact-form">
                    ...
                    <form id="contact-us" method="post" action="reserve.php">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8 col-md-6 col-xs-12 ftr-12">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-6">
                                            <!-- Name -->
                                            <input type="text" name="name" id="name" required="required" class="form" placeholder="Name" />
                                            <input type="text" name="date" id="date" required="required" class="form" placeholder="Date" />
                                            <input type="text" name="time" id="time" required="required" class="form" placeholder="Time" />
    ...
    <section class="social_connect">
        <div class="text-content container">
            ...
            <div class="col-md-4">
                ...
                <span class="social_info"><a class="color_animation" href="tel:883-335-6524">+880XXXXXXXXXX</a></span>
            </div>
        </div>
    </section>
...
-->
    ...
    <footer class="sub_footer">
        <div class="container">
            <div class="col-md-4">
                <p class="sub-footer-text text-center">&copy; Brand Restaurant In Bangladesh</p>
            </div>
            <div class="col-md-4">
                <p class="sub-footer-text text-center">Back to <a href="#top">TOP</a></p>
            </div>
            <div class="col-md-4">
                <p class="sub-footer-text text-center">Build By Mubarok, Nehal, Rakib</p>
            </div>
        </div>
    </footer>
